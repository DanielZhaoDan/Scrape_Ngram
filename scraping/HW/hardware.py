...
sheet3_data = [['ID', 'Google Headline', 'Forum Thread', 'Forum Thread URL', 'Comment text', 'Date']]

keywords = ['Singtel', 'PC show']
scraped = set([])

cookie = '__qca=P0-1244388299-1500865044736; bbvbsessionhash=4415e5f06179246e0346f8bc56a8604b; bbvblastvisit=1500878246; bbvblastactivity=0; NSC_JO3kmqhuelqozbsbirjghwbnv43b3cq=ffffffff09a3640945525d5f4f58455e445a4a423660; _ga=GA1.3.190748673.1500865044; _gid=GA1.3.2029060280.1500865044; hwzbt_7b450bc2082de9d1650c211e1641a19e=ee1461b2e58787bde11c651e3a5f6816; _gat=1'
...
def request_sheet2(url, payload):
    ...
    for i in range(2, page_number+1):
        ...
        print payload.get('id', ''), ' -> sheet2--' + next_url, page_number
        try:
...
def get_sheet2_body(payload, html):
    ...
    for thread in thread_list:
        ...
        payload['sub_thread_url'] = sub_link
...
def get_sheet3_body(payload, html):
    ...
    for text in text_list:
        ...
        sub_thread_url = payload.get('sub_thread_url', '')
        ...
        one_row = [id, google_headline, sub_thread, sub_thread_url, text.replace('=', ''), date]
        ...
        try:
            ...
            if len(url_list) == 5:
                ...
                if i >= 48:
                    ...
                    write_old_excel('data/sheet_%d_2.xls' % i, sheet2_data)
                    write_old_excel('data/sheet_%d_3.xls' % i, sheet3_data)
                    del sheet2_data
                    del sheet3_data
                    sheet2_data = [['ID', 'Google Headline', 'Forum Thread URL', 'Sub-Forum Thread', 'Sub-Forum URL', 'Replies', 'Views']]
