...
alldata = []
diff_token='85cde7bd5fbb50f61ecc255ec20f3162'
...
def read_excel(filename, start):
    ...
    for i in range(start, table.nrows):
        try:
            if i not in [4, 7, 8, 13, 14, 17, 18, 23, 24, 27, 33, 37, 45, 48, 66, 68, 81, 82, 88, 90, 92, 94, 106, 107, 113, 114, 117, 120, 122, 126, 127, 129, 135, 138, 139, 141, 142, 149, 157, 158, 168, 174, 175, 176, 182, 187, 190, 194, 196, 197, 198, 200, 202, 203, 204, 205, 206, 208, 211, 212, 213, 220, 222, 225, 226, 227, 231, 233, 234, 235, 236, 239, 240, 256, 258, 260, 271, 275, 283, 299, 300, 302, 306, 310, 311, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 329, 331, 335, 340, 347, 349, 353, 359, 362, 371, 383, ]:
                continue
...
read_excel('data/PH.xlsx', 1)
write_excel('data/html1.xls', alldata)
